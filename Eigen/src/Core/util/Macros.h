...
// use the std versions.
  ...
  #define EIGEN_INHERIT_ASSIGNMENT_EQUAL_OPERATOR(Derived) \
    using Base::operator =;
#elif EIGEN_COMP_CLANG && !defined(__circle_lang__) // workaround clang bug (see http://forum.kde.org/viewtopic.php?f=74&t=102653)
    // This code is a bug:
    // https://github.com/cplusplus/CWG/issues/298
  #define EIGEN_INHERIT_ASSIGNMENT_EQUAL_OPERATOR(Derived) \
    using Base::operator =; \
